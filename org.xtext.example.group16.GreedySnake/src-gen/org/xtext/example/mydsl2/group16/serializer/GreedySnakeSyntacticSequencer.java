...
public class GreedySnakeSyntacticSequencer extends AbstractSyntacticSequencer {

	protected GreedySnakeGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (GreedySnakeGrammarAccess) access;
