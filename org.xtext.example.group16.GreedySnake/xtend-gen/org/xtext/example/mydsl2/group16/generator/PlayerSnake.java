...
public class PlayerSnake extends GeneralGenerator {
  ...
  public CharSequence generatePlayerSnake() {
    ...
    _builder.newLine();
    _builder.append("\t ");
    _builder.append("* 这里说明一下，由于游戏的主界面类时MainWindow，而PlayerSnake类需要和MainWindow交换一些信息，即两个类有通信需求，");
    _builder.newLine();
    _builder.append("\t ");
    _builder.append("* 故需要把MainWindow类作为PlayerSnake构造函数的参数以达到能访问其中变量和函数的目的");
    _builder.newLine();
    _builder.append("\t ");
    _builder.append("*/");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("private Direction direction = Direction.RIGHT;//蛇当前前进的方向,初始化默认向右移动");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("private int speed = 300;//用于描述蛇移动速度的变量，其实是作为蛇刷新线程的时间用的");
    _builder.newLine();
    _builder.append("\t");
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("if(checkDeath(next_coor))//判断下一步是否死亡");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("{");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("new Music(\"music//over.wav\").start();");
    _builder.newLine();
    _builder.append("\t\t\t");
    ...
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("int result=JOptionPane.showConfirmDialog(null, \"Game over! Try again?\", ");
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    _builder.append("\"Information\", JOptionPane.YES_NO_OPTION);");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("if(result==JOptionPane.YES_NO_OPTION)");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("{");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("GameUI.restart();");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("body.addFirst(next_node);//添头");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("//modify");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("//GameUI.map[next_node.coor.y][next_node.coor.x] = 1;//标记为蛇身体节点");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("GameUI.setMap(next_node.coor.y, next_node.coor.x, 1);");
    _builder.newLine();
    _builder.append("\t\t\t");
    ...
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("if(!checkEat(next_coor))//没吃到食物就去尾，否则不用去掉，因为添加的头刚好是吃到一个食物后增长的一节");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("{");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("Body tail = body.pollLast();//去尾");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("//GameUI.map[tail.coor.y][tail.coor.x] = 0;//标记为空闲");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    ...
    _builder.newLine();
    _builder.append("\t");
    final Function1<InitialObstacleSpecificatin, CharSequence> _function_2 = (InitialObstacleSpecificatin o) -> {
      return this.CheckDeath(o);
    };
    String _join_2 = IterableExtensions.<InitialObstacleSpecificatin>join(this.gs.getObstacles(), "", _function_2);
    _builder.append(_join_2, "\t");
    _builder.newLineIfNotEmpty();
    _builder.append("\t");
    _builder.newLine();
    _builder.append("\t");
    final Function1<InitialFoodSpecificatin, CharSequence> _function_3 = (InitialFoodSpecificatin fd) -> {
      final Function1<InitialSnakeSpecificatin, CharSequence> _function_4 = (InitialSnakeSpecificatin sk) -> {
        return this.CheckEat(fd, sk);
      };
      return IterableExtensions.<InitialSnakeSpecificatin>join(this.gs.getSnakes(), "", _function_4);
    };
    String _join_3 = IterableExtensions.<InitialFoodSpecificatin>join(this.gs.getFoods(), "", _function_3);
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("GameUI.getWeaponLabel().setText(\"\" + bulletNumber);//刷新界面上显示的子弹数目");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder_1.append("\"");
    final Function1<GlobalMap, CharSequence> _function_4 = (GlobalMap m) -> {
      return m.getMap();
    };
    String _join_4 = IterableExtensions.<GlobalMap>join(this.gs.getMap(), "", _function_4);
    String _plus = (_builder_1.toString() + _join_4);
    ...
    _builder.newLine();
    _builder.append("\t\t");
    final Function1<InitialFireSpecification, CharSequence> _function_5 = (InitialFireSpecification o) -> {
      return this.generateFire(o);
    };
    String _join_5 = IterableExtensions.<InitialFireSpecification>join(this.gs.getFire(), "", _function_5);
    _builder.append(_join_5, "\t\t");
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t");
    _builder.newLine();
    _builder.append("\t\t    ");
    _builder.append("//初始化火焰起始坐标");
    _builder.newLine();
    _builder.append("\t\t    ");
    _builder.append("if(moveDirection == Direction.UP)");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("{");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("fireCoor = new Coordinate(snakehead.x,snakehead.y-1);");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    ...
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("else if(moveDirection == Direction.DOWN)");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("{");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("else if(moveDirection == Direction.LEFT)");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("{");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("fireCoor = new Coordinate(snakehead.x-1,snakehead.y);");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("}");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("else if(moveDirection == Direction.RIGHT)");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("{");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("if(target.x < 0 || target.x > GameUI.getAreaWidth() || target.y < 0 || target.y > GameUI.getAreaHeight()){}//运动到屏幕外不播放音效");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("else new Music(\"music//explode.wav\").start();//击中障碍物播放音效");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    _builder.append("Thread.sleep(50);//每隔50毫秒刷新一次");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("} catch (InterruptedException e) {");
    _builder.newLine();
  ...
  public CharSequence CheckEat(final InitialFoodSpecificatin ifs, final InitialSnakeSpecificatin iss) {
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("if(_point == 0)//食物是子弹");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("{");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("GameUI.getScoreLabel().setText(\"\" + point);//在界面上刷新得分");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("GameUI.getLengthLabel().setText(\"\" + body.size());//刷新身体长度");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("//GameUI.map[coor.y][coor.x] = ");
    int _snakeTag = iss.getMembers().getSna().getSnakeTag();
    _builder.append(_snakeTag, "\t\t");
    _builder.append(";//把地图上的该点标记为1，代表蛇身体");
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t");
  ...
  public CharSequence generateMusic(final MusicSpecification music) {
    CharSequence _xblockexpression = null;
    {
      ...
      _builder.newLine();
      _builder.append("if(_point == -1)//没吃到食物");
      _builder.newLine();
      _builder.append("return false;");
      _builder.newLine();
      _builder.append("else//吃到了食物");
      _builder.newLine();
      _builder.append("{");
      _builder.newLine();
  ...
  public CharSequence CheckDeath(final InitialObstacleSpecificatin ios) {
    ...
    _builder.newLine();
    _builder.append("/*注意，coor.x是map数组中的列号，从左到右依次为[0,WIDTH-1]");
    _builder.newLine();
    _builder.append(" ");
    _builder.append("*     coor.y是map数组中的行号，从上到下依次为[0,HEIGHT-1]");
    _builder.newLine();
    _builder.append("*/");
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    ...
    _builder.newLineIfNotEmpty();
    _builder.append("       ");
    _builder.append("//GameUI.map[coor.y][coor.x] == 3)");
    _builder.newLine();
    _builder.append("       ");
    _builder.append("return true;");
    _builder.newLine();
  ...
  public CharSequence generateMove(final InitialSnakeSpecificatin iss) {
    StringConcatenation _builder = new StringConcatenation();
    _builder.append("public void move(){");
    _builder.newLine();
    ...
    _builder.append(");");
    _builder.newLineIfNotEmpty();
    _builder.append("if(direction == Direction.UP){");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("head = body.getFirst().coor;//get head");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("next_coor = new Coordinate(head.x,head.y - 1);//head up 1");
    _builder.newLine();
    _builder.append("}");
    _builder.newLine();
    _builder.append("else if(direction == Direction.DOWN){");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("head = body.getFirst().coor;//get head");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("next_coor = new Coordinate(head.x,head.y + 1);//head down 1");
    _builder.newLine();
    _builder.append("}");
    _builder.newLine();
    _builder.append("else if(direction == Direction.LEFT){");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("head = body.getFirst().coor;//get head");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("next_coor = new Coordinate(head.x - 1,head.y);//head left 1");
    _builder.newLine();
    _builder.append("}");
    _builder.newLine();
    _builder.append("else if(direction == Direction.RIGHT){");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("head = body.getFirst().coor;//get head");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("next_coor = new Coordinate(head.x + 1,head.y);//head right 1");
    _builder.newLine();
    _builder.append("}");
    _builder.newLine();
    return _builder;
  ...
  public CharSequence generatePlaySnake(final InitialSnakeSpecificatin iss) {
    CharSequence _xblockexpression = null;
    {
      ...
      _builder.append(";//默认速度");
      _builder.newLineIfNotEmpty();
      _builder.append("private Deque<Body> body = new LinkedList<Body>();//用于描述蛇身体节点的数组，保存蛇身体各个节点的坐标");
      _builder.newLine();
      _builder.append("private double point = 0;//当前蛇得了多少分");
      _builder.newLine();
      _builder.append("private int bulletNumber = 20;//蛇的子弹数目");
      _builder.newLine();
      _builder.append("\t\t\t\t");
      _builder.newLine();
      ...
      _builder.newLine();
      _builder.append("//加载4张蛇头和4张蛇身体图片");
      _builder.newLine();
      _builder.newLine();
      ...
      _builder.newLine();
      {
        ...
        for(final Integer idx : _upTo) {
          ...
          _builder.append(idx, "\t    ");
          _builder.append("] = new ImageIcon(");
          String _get_3 = locateBody.get((idx).intValue());
      ...
      int _initial_y = iss.getMembers().getSna().getInitial_y();
      _builder.append(_initial_y);
      _builder.append(",headIcon[headIconTag]);//初始化头部在(0,0)位置");
      _builder.newLineIfNotEmpty();
