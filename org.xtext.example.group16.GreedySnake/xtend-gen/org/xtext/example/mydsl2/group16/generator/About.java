...
public class About extends GeneralGenerator {
  ...
  public CharSequence generateAbout() {
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("protected void paintComponent(Graphics g1) {");
    _builder.newLine();
    _builder.append("        ");
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("int width = getWidth();");
    _builder.newLine();
    _builder.append("        ");
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("g.fillRect(0, 0, width, height);");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("private Font f1 = new Font(\"Calibri\",Font.PLAIN,15);");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("private Font f2 = new Font(\"Calibri\",Font.PLAIN,20);");
    _builder.newLine();
    _builder.append("\t");
  ...
  public CharSequence generateAboutContext(final AboutSpecification asf) {
    ...
    _builder.newLine();
    _builder.append("icon.setImage(icon.getImage().getScaledInstance(120,120,Image.SCALE_SMOOTH));");
    _builder.newLine();
