...
public class FoodSet extends GeneralGenerator {
  ...
  public CharSequence generateFoodSet() {
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("//食物的数据结构");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("public class Food {");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("int kind;//食物种类，0-5对应5种不同的食物，见文档说明");
    _builder.newLine();
    _builder.append("\t\t");
  ...
  public CharSequence generatefoodset(final InitialFoodSpecificatin ifs) {
    CharSequence _xblockexpression = null;
    {
      ...
      _builder.newLine();
      _builder.append("private List<Food> food = new LinkedList<Food>();//用于描述食物的数组");
      _builder.newLine();
      ...
      _builder.newLineIfNotEmpty();
      _builder.append("\t\t\t");
      _builder.append("private double[] point = new double[FOODKIND];//6中食物各自对应的得分");
      _builder.newLine();
      _builder.append("\t\t\t");
      _builder.append("private ImageIcon[] foodIcon = new ImageIcon[FOODKIND];//6种食物各自对应的图标");
      _builder.newLine();
      _builder.append("\t\t\t");
      _builder.newLine();
      _builder.append("\t\t\t");
      ...
      _builder.newLine();
      _builder.append("\t\t\t");
      _builder.append("private int time = 10000;//10秒移动刷新一次");
      _builder.newLine();
      _builder.append("\t\t\t");
      ...
      _builder.newLine();
      _builder.append("\t\t\t\t");
      _builder.append("/*给定界面上的一个点，判断该点是否有食物存在，若有，则返回对应食物的得分，否则返回-1");
      _builder.newLine();
      _builder.append("\t\t\t\t ");
      _builder.append("* 注意coor.x代表横向的序号，从左到右依次为[0,WIDTH-1]");
      _builder.newLine();
      _builder.append("\t\t\t\t ");
      _builder.append("* coor.y代表纵向的序号，从上到下依次为[0,HEIGHT-1]");
      _builder.newLine();
      _builder.append("\t\t\t\t ");
      _builder.append("*/");
      _builder.newLine();
      ...
      _builder.newLine();
      _builder.append("\t\t\t\t\t\t");
      _builder.append("node.label.setVisible(false);//从界面上移除食物");
      _builder.newLine();
      _builder.append("\t\t\t\t\t\t");
      _builder.append("GameUI.remove(node.label);");
      _builder.newLine();
      _builder.append("\t\t\t\t\t\t");
      _builder.append("iter.remove();//从food数组中移除被吃掉的食物");
      _builder.newLine();
      _builder.append("\t\t\t\t\t\t");
      _builder.newLine();
      _builder.append("\t\t\t\t\t\t");
      _builder.append("produceFood();//注意每次吃完食物后增加随机数量的食物，保证界面上食物的数量维持在[0,MINSIZE-1]之间");
      _builder.newLine();
      _builder.append("\t\t\t\t\t\t");
      _builder.newLine();
      _builder.append("\t\t\t\t\t\t");
      ...
      _builder.newLine();
      _builder.append("\t\t\t\t\t\t");
      _builder.append("return point[node.kind];//返回该食物对应的分数");
      _builder.newLine();
      _builder.append("\t\t\t\t\t");
      _builder.append("}");
      _builder.newLine();
      ...
      _builder.newLine();
      _builder.append("\t\t\t\t\t");
      _builder.append("Coordinate coor = GameUI.produceRandomCoordinate();//注意，coor.x是数组的行，coor.y是数组的列，和界面上的行序号和列序号正好相反");
      _builder.newLine();
      _builder.append("\t\t\t\t\t");
      _builder.append("Coordinate _coor = new Coordinate(coor.y,coor.x);//置换行和列");
      _builder.newLine();
      _builder.append("\t\t\t\t\t");
      ...
      _builder.newLine();
      _builder.append("\t\t\t\t\t");
      _builder.append("//GameUI.map[coor.x][coor.y] = 2;//x行，y列");
      _builder.newLine();
      _builder.append("\t\t\t\t\t");
      ...
      _builder.newLine();
      _builder.append("\t\t");
      _builder.append("//\t\t\t\t\tIndexToPixel.getYPixel(newfood.coor.x), 20, 20);//注意，x指的是是第几行，对应的是纵坐标");
      _builder.newLine();
      _builder.append("\t\t");
      _builder.append("//\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t//同理，y指的是是第几列，对应的是横坐标");
      _builder.newLine();
      _builder.append("\t\t\t\t");
      _builder.append("}");
      _builder.newLine();
      ...
      _builder.newLine();
      _builder.append("\t\t\t\t");
      _builder.append("GameUI.getAmountLabel().setText(\"\" + food.size());//刷新GameUI界面上显示食物数量的Label");
      _builder.newLine();
      _builder.append("\t\t\t\t");
      _builder.append("show();");
      _builder.newLine();
